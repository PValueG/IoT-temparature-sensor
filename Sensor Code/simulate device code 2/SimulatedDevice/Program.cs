...
namespace SimulatedDevice
{
    ...
    internal class Program
    {
        ...
        private static string s_connectionString = "HostName=PGoodalliOtHUB.azure-devices.net;DeviceId=pgoodall_simdevice;SharedAccessKey=tsNynFiD8S1DjYflVpS5+22ESPSowPBl4LfD9f6jvtI=";
        ...
        private static async Task SendDeviceToCloudMessagesAsync(CancellationToken ct)
        {
            ...
            while (!ct.IsCancellationRequested)
            {
                ...
                double currentHeartRate = minHeartRate + rand.NextDouble() * 4;
